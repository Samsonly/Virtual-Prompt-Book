...
const LineNotes = ({ characterName, characterDialogue, }) => {
    ...
    const [lineCalled, setLineCalled] = (0, react_1.useState)(false);
    const [wrongWords, setWrongWords] = (0, react_1.useState)(false);
    const [addedWords, setAddedWords] = (0, react_1.useState)(false);
    const [droppedWords, setDroppedWords] = (0, react_1.useState)(false);
    const [outOfOrder, setOutOfOrder] = (0, react_1.useState)(false);
    const [missedCue, setMissedCue] = (0, react_1.useState)(false);
    const [jumpedCue, setJumpedCue] = (0, react_1.useState)(false);
    const [other, setOther] = (0, react_1.useState)(false);
    ...
    const saveLineNote = () => {
        ...
        const existingCharacterIndex = updatedLineNotes.findIndex((note) => note.hasOwnProperty(characterName));
