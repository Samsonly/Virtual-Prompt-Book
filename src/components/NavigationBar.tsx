...
function NavigationBar() {
  ...
  const handleNewProjectClick = (callback: () => void) => {
  ...
  const handleItemClick = (e: MouseEvent, item: string) => {
    e.stopPropagation();
        ...
        {activeDropdown === 3 && (
          <div className="dropdown-content">
            ...
            <div
              className="dditem"
              id="dd3item3"
              onClick={(e) => handleItemClick(e, "Production Team")}
            >
              Production Team
            </div>
            <div
              className="dditem"
              id="dd3item2"
              onClick={(e) => handleItemClick(e, "Cast List")}
            >
              Cast List
            </div>
